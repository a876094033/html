...
$("#burger").on("click", function() {
    if (!$("#burger").is(":checked") && $(window).scrollTop() <= 50) {
        $(".navbar").removeClass("active");
    }
    /*else {
...
$("#gnb").on("click", function() {
    if (!$("#gnb").is(":checked") && $(window).scrollTop() <= 50) {
        $(".navbar").removeClass("active");
    }
    /*else {
			$(".header").addClass("active");
...
! function(a) {
    ...
    a.create = function() {
        ...
        set: function(a) {
            this.element.checked = a, this.$element.trigger("change")
        },
        keydown: function(b) {
            -1 != a.inArray(b.keyCode, this.options.toggleKeyCodes) ? (b.preventDefault(), this.change()) : 13 == b.keyCode && a(this.element.form).trigger("submit")
        },
        reset: function() {
    ...
    }, a.fn.checkboxpicker.Constructor = b, a.fn.checkboxpicker.noConflict = function() {
        return a.fn.checkboxpicker = d, this
    }, a.fn.checkboxpicker
});
...
! function(a, b) {
    ...
    ! function(a) {
        ...
        l.VERSION = "1.12.4", l.DEFAULTS = {
            noneSelectedText: "선택값이 없습니다.",
            noneResultsText: "{0} 일치하는 값이 없습니다.",
            ...
            createDropdown: function() {
                var b = this.multiple || this.options.showTick ? " show-tick" : "",
                    ...
                    f = this.options.liveSearch ? '<div class="bs-searchbox input-group"><input type="text" class="form-control" autocomplete="off" placeholder="검색" role="textbox" aria-label="Search"><span class="input-group-addon"><button type="submit"><span class="glyphicon glyphicon-search"></span></button></span></div>' : "",
